# HIP-Doc Compilation APIs Example

## Description

This example demonstrates how to compile a kernel at runtime using the HIPRTC API. For more information on this topic,
please refer to the
[HIP documentation](https://rocm.docs.amd.com/projects/HIP/en/latest/how-to/hip_rtc.html#compilation-apis).
