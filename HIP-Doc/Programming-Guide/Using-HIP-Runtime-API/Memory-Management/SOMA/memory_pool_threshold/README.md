# HIP-Doc Memory Pool Threshold Example

## Description

This example demonstrates how to use the stream ordered memory allocation (SOMA) API to set up and manage a memory
pool, while defining a threshold to specify an amount of memory to reserve. For more information on this topic, please
refer to the
[HIP documentation](https://rocm.docs.amd.com/projects/HIP/en/latest/how-to/hip_runtime_api/memory_management/stream_ordered_allocator.html#trim-pools).
