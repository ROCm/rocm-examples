...
1. **Ampère-Maxwell Law (rotation of magnetic field)**
...
6. Check the consistency between CPU and GPU results.
7. If specified, output the results to binary files.
