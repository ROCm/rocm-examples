# HIP-Documentation Half-Precision Floating-Point Example
...
functionality for 16-bit floating-point numbers. The programming approach reflects the common theme of converting
