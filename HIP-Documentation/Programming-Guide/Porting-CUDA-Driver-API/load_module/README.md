# HIP-Documentation Load Module Example

## Description

This example demonstrates how to load precomcpiled code objects from disk and execute the contained kernel(s). For more
...
4. A precompiled code module is loaded from disk.
...
* `hipModuleLoad` loads a precompiled code module from disk.
