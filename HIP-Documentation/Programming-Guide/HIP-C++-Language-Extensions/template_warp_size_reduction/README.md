# HIP-Documentation Template Warp Size Reduction Example

## Description

This example demonstrates how to determine the warp size of the GPU on host side and accordingly setup a kernel which
depends on the warp size at compile time. For more information on this topic, please refer to the
[HIP documentation](https://rocm.docs.amd.com/projects/HIP/en/latest/how-to/hip_cpp_language_extensions.html#warpsize).

This example is intended for comparison with the [warp size reduction example](../warp_size_reduction).
...
7. A reduction kernel which takes the warp size as template parameter is launched.
