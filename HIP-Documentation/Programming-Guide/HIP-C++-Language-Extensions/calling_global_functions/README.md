# HIP-Documentation Calling Global Functions Example

## Description

This example demonstrates how to call global device functions (kernels). For more information on this topic, please
refer to the
[HIP documentation](https://rocm.docs.amd.com/projects/HIP/en/latest/how-to/hip_cpp_language_extensions.html#global).
