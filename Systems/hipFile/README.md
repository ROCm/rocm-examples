...
| [`no_odirect_write`](basics/no_odirect_write) | Register a file opened *without* `O_DIRECT`. hipFile falls back to the POSIX compat path. Requires `HIPFILE_ALLOW_COMPAT_MODE=1`. | `OUTPUT [GPUID]` |
