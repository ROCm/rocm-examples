...
This example shows how the number of HIP-capable devices in the system can be determined, as well as how properties from the device may be queried.

### Application flow

* The number of devices in the system is queried, and for each device:
  * The device properties are queried and the device name is printed.
