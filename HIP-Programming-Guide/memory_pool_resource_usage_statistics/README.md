# HIP-Programming-Guide Memory Pool Resource Usage Statistics Example
...
Resource usage statistics help in optimization. This example demonstrates how to query them for a memory pool.
