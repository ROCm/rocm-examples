# HIP-Programming-Guide Sequential Kernel Execution Example
...
operations. It should be compared to the [asynchronous kernel execution example](../asynchronous_kernel_execution) and the
[event-based asynchronous kernel execution example](../event_based_asynchronous_kernel_execution).
