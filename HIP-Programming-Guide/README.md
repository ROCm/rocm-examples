# HIP-Programming-Guide Examples
...
All examples in the `HIP-Programming-Guide` subdirectory can either be built by a single CMake project or be built independently.

- `$ cd HIP-Programming-Guide`
...
All examples in the `HIP-Programming-Guide` subdirectory can either be built by a single CMake project or be built independently. For build instructions refer to the top-level [README.md](../../README.md#cmake-2).
