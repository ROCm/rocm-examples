# rocALUTION Bi-Conjugate Gradient Stabilized (BiCGStab)

## Description

This example demonstrates the use of the `rocALUTION` library for solving nonsymmetric linear systems using the Bi-Conjugate Gradient Stabilized method.
...
The Bi-Conjugate Gradient Stabilized method is an iterative algorithm that improves upon the BiCG method by providing smoother convergence and avoiding breakdowns. It's particularly effective for nonsymmetric systems where CG cannot be applied.
...
10. Configure the BiCGStab solver with Multi-Colored Gauss-Seidel preconditioner.
...
- `rocalution::BiCGStab<rocalution::LocalMatrix<double>, rocalution::LocalVector<double>, double>`
